...
public:
    int minMeetingRooms(vector<Interval>& intervals) {
        ...
        int s = 0, e = 0;
        int count = 0, ans = 0;
        // the logic is to count the number
        // of overlapping meetings at any point in time.
        // the maximum number of these overlapping meetings
        // would be the minimum number of days required
        // to conduct meetings:
        while(s < n && e < n) {
            if(starts[s] < ends[e]) {
